...
lon.registerListener(function (val) {
  ...
  // crimeAPIURL = `https://api.crimeometer.com/v1/incidents/raw-data?lat=${lat.latitude}&lon=${lon.longitude}&distance=${distance}&datetime_ini=${startDate}&datetime_end=${endDate}&page=${page}`;
  // getCrime(crimeAPIURL)
  // console.log(distances(lat.latitude, lon.longitude, 40.6925478, -73.991));
  loadMap();
  findFood();
...
// function getCrime(crimeURL) {
//   let request = new XMLHttpRequest();

//   request.open('GET', crimeURL);

//   request.setRequestHeader('Content-Type', 'application/json');
//   request.setRequestHeader('x-api-key', crimeAPITestKey);
